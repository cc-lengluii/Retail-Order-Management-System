...
public class RegistrationForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(255, 208, 204));
        setBounds(new java.awt.Rectangle(0, 0, 760, 480));
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Panel.setBackground(new java.awt.Color(255, 208, 204));
        Panel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        Panel.add(lastNameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 157, 145, -1));
        Panel.add(firstNameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 157, 151, -1));
        Panel.add(mobileNoTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 208, 148, -1));
        Panel.add(emailTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 238, 148, -1));

        signUpBtn.setBackground(new java.awt.Color(42, 179, 255));
        ...
        Panel.add(signUpBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 418, -1, 38));

        lblUsername.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        lblUsername.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblUsername.setText("Username");
        Panel.add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, -1, -1));

        lblPassword.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        lblPassword.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblPassword.setText("Password");
        Panel.add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, -1, -1));

        lblComfirmPass.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        lblComfirmPass.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblComfirmPass.setText("Comfirm Password");
        Panel.add(lblComfirmPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, -1, 20));
        ...
        Panel.add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 50, -1));
        ...
        Panel.add(streetNoTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 272, 80, -1));
        Panel.add(streetNameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 319, 460, -1));

        lblStreetNo.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblStreetNo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblStreetNo.setText("Street No.");
        Panel.add(lblStreetNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, 59, -1));

        lblStreetName.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblStreetName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblStreetName.setText("Street Name");
        Panel.add(lblStreetName, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 341, 71, -1));

        lblCity.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblCity.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblCity.setText("City");
        Panel.add(lblCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 397, 40, -1));

        lblState.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblState.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblState.setText("State");
        Panel.add(lblState, new org.netbeans.lib.awtextra.AbsoluteConstraints(415, 397, 40, -1));

        lblName.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        lblName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblName.setText("Full Name");
        Panel.add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, -1, -1));

        lblFirstName.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblFirstName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFirstName.setText("First Name");
        Panel.add(lblFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 182, -1, -1));

        lblPostCode.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblPostCode.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblPostCode.setText("Postal /Zip Code");
        Panel.add(lblPostCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 443, 88, -1));

        lblLastName.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblLastName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblLastName.setText("Last Name");
        Panel.add(lblLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 182, -1, -1));

        lblCountry.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
        lblCountry.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblCountry.setText("Country");
        Panel.add(lblCountry, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 443, 88, -1));
        ...
        Panel.add(lblMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, -1, -1));

        comfirmPassTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comfirmPassTxtActionPerformed(evt);
            }
        });
        Panel.add(comfirmPassTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 132, 151, -1));

        lblEmail.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        lblEmail.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblEmail.setText("E-mail");
        Panel.add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, -1, -1));
        Panel.add(passwordTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 106, 151, -1));
        ...
        Panel.add(lblGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(581, 161, -1, -1));
        ...
        Panel.add(usernameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 76, 151, -1));
        ...
        lblTitle.setText("NEW CUSTOMER REGISTRATION");
        ...
        Panel.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, -1));

        maleRbtn.setBackground(new java.awt.Color(255, 208, 204));
        buttonGroup1.add(maleRbtn);
        maleRbtn.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        maleRbtn.setText("Male");
        Panel.add(maleRbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 157, 93, -1));

        femaleRbtn.setBackground(new java.awt.Color(255, 208, 204));
        buttonGroup1.add(femaleRbtn);
        femaleRbtn.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        femaleRbtn.setText("Female");
        Panel.add(femaleRbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 180, 93, -1));
        ...
        Panel.add(jcbZip, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 418, 76, -1));
        ...
        Panel.add(jcbState, new org.netbeans.lib.awtextra.AbsoluteConstraints(415, 374, 108, -1));
        ...
        Panel.add(jcbCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(231, 374, 130, -1));

        jcbCountry.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Malaysia" }));
        Panel.add(jcbCountry, new org.netbeans.lib.awtextra.AbsoluteConstraints(415, 418, 108, -1));
        ...
        Panel.add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 80, 40));
    ...
    private void comfirmPassTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comfirmPassTxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comfirmPassTxtActionPerformed
    ...
    private void signUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpBtnActionPerformed
        ...
        customer.name.setName(fName, lName); //composition : set name

        //Auto Generate unique ID for customer
        String id = new CustomerManager().generateID();
        customer.setCusID(id);

        customer.address.setAddress(streetNo, streetName, city, state, postCode, country); //composition : set address
