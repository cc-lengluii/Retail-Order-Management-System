 ...
 * @author user
 */
public final class EditCustomer extends javax.swing.JFrame {
    ...
    public void displayCustomerDetails() {
        ...
        String cusName = model.getValueAt(selectedRow, 1).toString();
        String[] sName = cusName.split("  ");
        txtFName.setText(sName[0]);
        txtLName.setText(sName[1]);

        String cusGender = model.getValueAt(selectedRow, 2).toString();
        if ("M".equals(cusGender)) {
            maleRbtn.setSelected(true);
        } else if ("F".equals(cusGender)) {
            femaleRbtn.setSelected(true);
        }
        String cusPhone = model.getValueAt(selectedRow, 3).toString();
        txtContact.setText(cusPhone);
        String cusEmail = model.getValueAt(selectedRow, 4).toString();
        txtEmail.setText(cusEmail);

        String cusAddress = model.getValueAt(selectedRow, 5).toString();
        String[] sAddress = cusAddress.split("  ");
        txtStreetNo.setText(sAddress[0]);
        txtStreetName.setText(sAddress[1]);
        jcbCity.setSelectedItem(sAddress[2]);
        jcbState.setSelectedItem(sAddress[3]);
        jcbZip.setSelectedItem(sAddress[4]);
        jcbCountry.setSelectedItem(sAddress[5]);
    }
    ...
    public TableRowSorter<DefaultTableModel> sortTable() {
        ...
        TableRowSorter<DefaultTableModel> sortTable = new TableRowSorter<>(table);
    ...
    private void initComponents() {
        ...
        updateCusbtn1 = new javax.swing.JButton();
        lblStreetNo1 = new javax.swing.JLabel();
        lblStreetNo2 = new javax.swing.JLabel();
        lblStreetNo3 = new javax.swing.JLabel();
        lblStreetNo4 = new javax.swing.JLabel();
        ...
        Rightpanel.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, -1, -1));
        ...
        Rightpanel.add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 450, 40));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel14.setText("SEARCH");
        Rightpanel.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, -1, -1));

        customerTbl.setBackground(new java.awt.Color(254, 242, 242));
        customerTbl.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        ...
        customerTbl.setGridColor(new java.awt.Color(255, 204, 204));
        ...
        if (customerTbl.getColumnModel().getColumnCount() > 0) {
            ...
            customerTbl.getColumnModel().getColumn(5).setResizable(false);
            customerTbl.getColumnModel().getColumn(5).setPreferredWidth(500);
        }

        Rightpanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 890, 270));
        ...
        Rightpanel.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, -1, -1));

        txtStreetName.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Rightpanel.add(txtStreetName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 270, -1));

        lblContact.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblContact.setText("Email");
        Rightpanel.add(lblContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 180, 50, 20));

        lblAddress.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblAddress.setText("Address");
        Rightpanel.add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 70, 20));

        txtEmail.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Rightpanel.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 180, 150, -1));

        txtLName.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Rightpanel.add(txtLName, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 180, 130, -1));

        lblGender.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblGender.setText("Gender");
        Rightpanel.add(lblGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, 60, 30));

        txtContact.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Rightpanel.add(txtContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 180, 110, -1));

        lblLName.setText("Last  Name");
        Rightpanel.add(lblLName, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 100, 50));

        txtFName.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Rightpanel.add(txtFName, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 120, -1));

        txtStreetNo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Rightpanel.add(txtStreetNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 80, -1));

        lblName.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblName.setText("Full Name");
        Rightpanel.add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 110, 30));

        lblStreetName.setText("Street Name");
        Rightpanel.add(lblStreetName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 100, 30));

        lblFName.setText("First  Name");
        Rightpanel.add(lblFName, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 90, 30));

        lblStreetNo.setText("Country");
        Rightpanel.add(lblStreetNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 260, 60, 40));

        jcbCity.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        Rightpanel.add(jcbCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 240, 110, -1));
        ...
        Rightpanel.add(jcbState, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 240, -1, -1));

        jcbZip.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        Rightpanel.add(jcbZip, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 240, 90, -1));

        jcbCountry.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        Rightpanel.add(jcbCountry, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 240, 100, -1));

        deleteCusbtn.setBackground(new java.awt.Color(255, 51, 51));
        ...
        Rightpanel.add(deleteCusbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 320, 90, 40));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(89, 89, 89));
        jLabel12.setText("Edit Customer ");
        Rightpanel.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, -1, -1));

        updateCusbtn1.setBackground(new java.awt.Color(0, 153, 255));
        updateCusbtn1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        updateCusbtn1.setForeground(new java.awt.Color(255, 255, 255));
        updateCusbtn1.setText("Update");
        updateCusbtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateCusbtn1ActionPerformed(evt);
            }
        });
        Rightpanel.add(updateCusbtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 320, 90, 40));

        lblStreetNo1.setText("Street No");
        Rightpanel.add(lblStreetNo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, 70, 30));

        lblStreetNo2.setText("City");
        Rightpanel.add(lblStreetNo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 260, 40, 40));

        lblStreetNo3.setText("State");
        Rightpanel.add(lblStreetNo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 260, 70, 40));

        lblStreetNo4.setText("Zip Code");
        Rightpanel.add(lblStreetNo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 260, 70, 40));

        lblContact1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblContact1.setText("Contact Number");
        Rightpanel.add(lblContact1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 180, 130, 20));

        femaleRbtn.setBackground(new java.awt.Color(254, 242, 242));
        rbtnGender.add(femaleRbtn);
        femaleRbtn.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        femaleRbtn.setText("Female");
        Rightpanel.add(femaleRbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 200, 80, 20));
        ...
        Rightpanel.add(maleRbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 170, 100, -1));

        Background.add(Rightpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 0, 920, 660));
    ...
    private void deleteCusbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteCusbtnActionPerformed
        CustomerManager manager = new CustomerManager();
        try {
            int choice = JOptionPane.showConfirmDialog(null, "Are you sure to delete this customer?", "Delete", JOptionPane.YES_NO_OPTION);
            if (choice == 0) {
                ArrayList<Customer> customerList = manager.read(); //read all customer objects from file to arraylist
                int row = customerTbl.getSelectedRow();
                int selectedRow = customerTbl.convertRowIndexToModel(row);
                ArrayList<Order> orderList = new OrderManager().read();
                String deleteCus = customerList.get(selectedRow).getCusID();
                for (int i = 0; i < orderList.size(); i++) {
                    if (orderList.get(i).getCustomer().getCusID().equals(deleteCus)) {
                        JOptionPane.showMessageDialog(this, "Cannot delete the customer that has place order");
                        return;
                    }
                }
                customerList.remove(selectedRow); //delete a particular customer details
                ...
                new User().delete(ID);          //delete the customer account
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        search.setRowFilter(RowFilter.regexFilter("(?i)" + searchCus));

    }//GEN-LAST:event_txtSearchKeyReleased

    private void updateCusbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateCusbtn1ActionPerformed

        if (txtContact.getText().equals("") || txtEmail.getText().equals("") || txtStreetNo.getText().equals("") || txtStreetName.getText().equals("")
                || txtFName.getText().equals("") || txtLName.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please fill up the blank");
            return;
        }

        if (new CustomerManager().isStringNumeric(txtContact.getText())) {
        ...
        if (row == -1) {
            ...
            try {
                ...
                customerList.get(selectedRow).name.setName(txtFName.getText(), txtLName.getText());
                if (maleRbtn.isSelected()) {
                    customerList.get(selectedRow).setGender('M');
                } else if (femaleRbtn.isSelected()) {
                    customerList.get(selectedRow).setGender('F');
                }

                customerList.get(selectedRow).setPhoneNo(txtContact.getText());
                customerList.get(selectedRow).setEmail(txtEmail.getText());
                customerList.get(selectedRow).address.setAddress(txtStreetNo.getText(), txtStreetName.getText(), jcbCity.getSelectedItem().toString(), jcbState.getSelectedItem().toString(), jcbZip.getSelectedItem().toString(), jcbCountry.getSelectedItem().toString());
    ...
    }//GEN-LAST:event_updateCusbtn1ActionPerformed
    ...
    private javax.swing.JLabel lblStreetNo1;
    private javax.swing.JLabel lblStreetNo2;
    private javax.swing.JLabel lblStreetNo3;
    private javax.swing.JLabel lblStreetNo4;
    ...
    private javax.swing.JButton updateCusbtn1;
